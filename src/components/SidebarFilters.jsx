    ...
    <div className="flex flex-col w-full md:w-80">
      ...
      <div className="flex flex-col p-4 gap-3">
        {Object.keys(options).map((filter) => (
          <details
            key={filter}
            className="flex flex-col rounded-lg border border-[#e0e0e0] bg-[#fefaf9] px-[15px] py-[7px] group"
          >
            <summary className="flex cursor-pointer items-center justify-between gap-6 py-2">
              <p className="text-black text-sm font-medium leading-normal">{filter}</p>
              <div className="text-black group-open:rotate-180">
            ...
            <div className="flex flex-col gap-2 pb-2">
              {options[filter].map((option) => (
                <label key={option.toString()} className="flex items-center gap-2 text-black text-sm font-normal">
                  <input
                    type="checkbox"
                    checked={
                      filter === 'Availability'
        ...
        >
          <summary className="flex cursor-pointer items-center justify-between gap-6 py-2">
            <p className="text-black text-sm font-medium leading-normal">Price Range</p>
            <div className="text-black group-open:rotate-180">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
              </svg>
          ...
          <div className="pt-2 pb-4">
            <div className="flex items-center gap-3">
              <input
                ...
                className="w-20 px-2 py-1 border border-[#ccc] text-black rounded text-sm bg-[#fefaf9] placeholder:text-gray-500"
                placeholder="Min"
              />
        ...
        <div className="flex gap-2 mt-2">
          ...
          <button
            ...
            className="flex-1 border border-[#141414] text-black text-sm font-semibold py-2 px-4 rounded hover:bg-[#f3f3f3] transition"
          >
            Clear
          </button>
        </div>
